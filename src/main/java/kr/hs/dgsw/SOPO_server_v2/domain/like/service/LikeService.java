...
//
//            Optional<LikeEntity> like = likeRepository.findByMemberAndBoard(member, board);
//
//            if (like.isEmpty()) {
//                addBoardLike(member, board);
//                board.likeUpdate(1);
//            } else {
...
//
//            Optional<LikeEntity> like = likeRepository.findByMemberAndContest(member, contest);
//
//            if (like.isEmpty()) {
//                addContestLike(member, contest);
